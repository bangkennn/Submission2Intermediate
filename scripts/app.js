...
import PengelolaLikedStories from './presenters/LikedStoriesPresenter.js';
import DataCerita from './models/StoryModel.js';
import { subscribeUser, unsubscribeUser } from './push.js';
import { saveStory, getStories, deleteStory } from './idb.js';
...
class App {
    ...
    _renderNavLinks() {
        ...
        ul.innerHTML = `
            ...
            <li><a href="#/liked">Liked Stories</a></li>
    ...
    _setupRouting() {
        const routes = {
            ...
            '/liked': () => {
                const likedStoriesPresenter = new PengelolaLikedStories();
                likedStoriesPresenter.tampilkan();
            },
            '/add': () => {
    ...
    _setupPushNotifications() {
        ...
        // Tambahkan tombol di UI untuk subscribe/unsubscribe jika perlu

        // --- PUSH NOTIFICATION BUTTONS ---
        const subscribeBtn = document.getElementById('subscribe-btn');
        const unsubscribeBtn = document.getElementById('unsubscribe-btn');

        // Ganti dengan cara mendapatkan token user kamu
        const token = localStorage.getItem('token'); // atau dari this._data jika ada
