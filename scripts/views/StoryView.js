class StoryView {
    ...
    _createStoryElement(story) {
        return `
            <article class="story-item" data-id="${story.id}" data-liked="${story.isLiked}">
                ...
                <div class="story-item__content">
                    ...
                    <div class="story-actions">
                        <button class="like-btn" aria-label="${story.isLiked ? 'Unlike' : 'Like'} story">
                            <i class="${story.isLiked ? 'fas' : 'far'} fa-heart"></i> ${story.isLiked ? 'Liked' : 'Like'}
                        </button>
                    </div>
                </div>
            </article>
